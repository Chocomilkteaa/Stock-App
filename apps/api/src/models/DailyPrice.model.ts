...
import { DailyPriceData } from '../services/DailyPrice.service.js';
import { log } from '@repo/logger';

export class DailyPriceModel {
  static async getDailyPricesByDate(date: string): Promise<DailyPriceData[]> {
    try {
  ...
  static async saveStocksAndPrices(data: DailyPriceData[], date: string): Promise<void> {
